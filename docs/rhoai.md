...
2) Go to the `Data Science Projects` section and access your application's project named `my-org-chatbot-workload`.

![image](./images/data-science-projects.png)

3) Access the `workbench` named `my-org-chatbot-workload-notebook`.
...
5) In the terminal, run `cd my-org-chatbot-workload` to navigate to your sample app's directory.
